...
export interface DividerLineProps extends React.HTMLProps<HTMLHRElement> {
    className?: string;
}

export interface EmphasizedTextProps extends React.HTMLProps<HTMLElement> {
...
export interface LinkTextProps extends React.HTMLProps<HTMLElement> {
    children: React.ReactNode;
    className?: string;
...
declare class StrongText extends React.Component<
    SimpleElementProps & React.HTMLProps<HTMLElement>,
    any
> {}
